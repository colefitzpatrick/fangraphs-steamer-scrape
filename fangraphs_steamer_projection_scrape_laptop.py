...
def fantraxscrape():
    ...
    href = driver.find_element_by_xpath('/html/body/app-root/div/div[2]/div/app-league-players/div/section/filter-panel/div/div[4]/div[3]/button[1]')
    downloadurl = href.get_attribute("href")
    print(url2)

    #downloads the file and puts it in Box, dynamically named with today's date
    myfile = requests.get(downloadurl)
    filename = "c:\\Python\\colefitzpatrick_python\\FantasyBaseballProjection\\fantrax2.csv"
